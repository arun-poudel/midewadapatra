// app/ward/[id]/departments/[departmentId]/services/page.tsx
...
export default async function WardDepartmentServicesPage({ params }: PageProps) {
...
// Ward Service Card Component
function WardServiceCard({ 
  service, 
  institutionId, 
  departmentId 
}: { 
      ...
      <CardContent>
        ...
        <div className="mt-4 space-y-2">
          <Button asChild className="w-full">
            <Link href={`/ward/${institutionId}/departments/${departmentId}/services/${service.id}`}>
