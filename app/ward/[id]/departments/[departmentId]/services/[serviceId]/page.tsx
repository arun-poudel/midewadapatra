// app/ward/[id]/departments/[departmentId]/services/[serviceId]/page.tsx
...
export default async function WardServiceDetailPage({ params }: PageProps) {
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Button variant="ghost" asChild>
              <Link href={`/ward/${params.id}/departments/${params.departmentId}/services`}>
                {department.name}
              </Link>
            </Button>
            <span className="text-gray-400">/</span>
