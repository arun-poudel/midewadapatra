// app/district/[id]/departments/[departmentId]/services/[serviceId]/page.tsx
...
export default async function DistrictServiceDetailPage({ params }: PageProps) {
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Button variant="ghost" asChild>
              <Link
                href={`/district/${params.id}/departments/${params.departmentId}/services`}
              >
                {department.name}
              </Link>
            </Button>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
              ...
              {department.name_nepali && (
                <>
                  <span>•</span>
                  <span>{department.name_nepali}</span>
                </>
              )}
            </div>
          ...
          <Tabs defaultValue="documents" className="w-full">
            ...
            <TabsContent value="process" className="mt-6">
              <Card>
                ...
                <CardContent>
                  {service.request_process &&
                  service.request_process.length > 0 ? (
                    <div className="space-y-4">
                      {service.request_process.map(
                    ...
                    <p className="text-gray-500">
                      No specific process steps listed.
                    </p>
                  )}
                </CardContent>
              </Card>
                    ...
                    {service.cost?.service_fee && (
                      <div>
                        ...
                        <div className="flex items-center gap-40 justify-between">
                          ...
                          <p className="text-gray-800 text-lg font-bold"> Total Rs:
                            {service.cost.service_fee}
                          </p>
                        </div>
                      </div>
